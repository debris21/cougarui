...
import { BehaviorFrameFormGroup } from "../user-account-info.component";
...
@Component({
    ...
    templateUrl: './user-account-info.details.component.html',
})

export class UserAccountInfoDetailComponent
{
    public form : BehaviorFrameFormGroup;
    public dDownList: KeyValue<string, string>[] = [];
    constructor(public dialog: MatDialog,private fs: ApproachpartService, @Inject(MAT_DIALOG_DATA) public data: any, private dialogRef: MatDialogRef<UserAccountInfoDetailComponent>,
